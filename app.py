...
.stSelectbox div[data-baseweb="select"] > div {background-color:#1c1f26; color:white;}
.stNumberInput input {background-color:#1c1f26; color:white;}
</style>
...
def dark_luxury_gauge(title, value, min_val, max_val, median_val):
    ...
    fig = go.Figure(go.Indicator(
        ...
        gauge={
            "axis": {"range":[min_val,max_val],"tickcolor":"#aaa"},
